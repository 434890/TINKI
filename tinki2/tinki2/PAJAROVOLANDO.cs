...
namespace  tinki2
{
	class PAJAROVOLANDO
	{
		...
		public void Update(GameTime gameTime,Vector2 position, Color color)
		{
		...
		public void Draw(SpriteBatch spriteBatch, Color colorpajaro)
		{
			if (Active)
			{
				spriteBatch.Draw(spriteStrip, destinationRect, sourceRect, colorpajaro);
			}
		}
	}
}
